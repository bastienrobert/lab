...
export default class RainbowPlane {
  constructor() {
  ...
  createUniforms() {
    ...
    this.resolutionMatrix = vec2.fromValues(
      this.canvas.width,
      this.canvas.height
    )

    this.gl.uniform2fv(this.resolutionUniformLocation, this.resolutionMatrix)
  }
}
